...
```
 ...
 The data shows similar patterns at the median year. The median birth rates of boys are higher than those of girls. Also the numbers of both data sets follow a similiar patter in the 1st quartile, the number for both boys and girls are higher than the median.
...
The data supports Arbuthnot's observation about boys being born in greater proportion than girls.
...
present[which.max(present$total), 1]
```
