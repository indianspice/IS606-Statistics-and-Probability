...
The square foot of homes sold is skewed to the right. Most of the homes sold have between 1,000 and 1,500 square foot of living space.
...
THe distribution of the sample is similiar to the shape of the distribution of the populaion -- it is skewed to the left with most houses with square foot bewteen 1,000 and 1,500    
...
The mean of samp2 has less square foot from the sample mean of samp1. 
The mean of os slample size 1000 would be a more accurate estimation of the population mean.
...
There are approximately 4000 in 'sample_means50'
The shape of the sampling distribution is normal, with acenter of 1,500
No, I would not expect the shape to change.
...
When the sample size is larger the center is closer to that of the population. There is less spread as the sample size increases.
...
The shape of the distribution is normal. The mean homr price is approximately $180,000
...
THis is is the same of the above. The mean home price is $180,000
...
The sampling distribution n=150 has a smaller spread that the sampling distribution n=50
